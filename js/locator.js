...
//Hackaton edit: override map click to report, instead use native location of mobile device - atangeman20151005
function LocateAndReport() {
    ShowMyLocation(true);
}
//function to display the current location of the user
function ShowMyLocation(andReport) {
    ...
    function (position) {
        ...
        geometryService.project([graphicCollection], map.spatialReference, function (newPointCollection) {
            ...
            //hackathon code update - locate and initiate report on coordinate return atangeman20151005
            if (andReport){
